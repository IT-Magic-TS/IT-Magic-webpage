function Privacy() {
  return (
    <div className="w3-margin privacy">
      ...
      <p>
        Like any other website, Eve Star uses cookies. These cookies are used to
      ...
      <p>
        Eve Star Privacy Policy does not apply to other advertisers or websites.
      ...
      <p>
        ...
        shared and/or collect in Eve Star. This policy is not applicable to any
